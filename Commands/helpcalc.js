...
if(!l[args[1]) message.reply("Can't find that property / method. Make sure the case is correct :). To see a whole list of methods or properties, do `"+client.dprefix+"helpcalc`.").then(m=>m.delete({timeout:5000}))
